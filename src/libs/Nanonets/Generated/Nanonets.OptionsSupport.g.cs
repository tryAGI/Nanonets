...
namespace Nanonets
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Nanonets.AutoSDKRetryOptions Retry { get; set; } = new global::Nanonets.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Nanonets.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Nanonets.IAutoSDKHook>();
        ...
        public global::Nanonets.AutoSDKClientOptions AddHook(
            global::Nanonets.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Nanonets.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Nanonets.AutoSDKClientOptions UseAuthorizationProvider(
            global::Nanonets.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Nanonets.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Nanonets.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Nanonets.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Nanonets.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Nanonets.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Nanonets.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Nanonets.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Nanonets.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Nanonets.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Nanonets.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Nanonets.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Nanonets.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Nanonets.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Nanonets.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Nanonets.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Nanonets.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Nanonets.AutoSDKClientOptions clientOptions,
            global::Nanonets.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Nanonets.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Nanonets.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Nanonets.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Nanonets.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Nanonets.IAutoSDKHook, global::Nanonets.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Nanonets.AutoSDKHookContext context)
        {
